...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Veterans Treatment Court Case Management System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "VeteranParticipant";
process.env.TABLE_NAME = process.env.TABLE_NAME || "veteranparticipant_records";
'use strict';
